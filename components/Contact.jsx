...
const Contact = () => {
  ...
  return (
    <div id="contact" className='contact-back text-white flex flex-col justify-center items-center bg-primary-300 py-20 sm:px-20 px-2 w-full  min-h-full'>
      <div className="sm:border-b-2 border-b border-b-slate-800  mb-10 w-96 flex justify-center items-center pb-10">
          <Link href={"https://www.instagram.com/vinay_kumar.0.0/?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"} className="flex justify-center items-center px-4 py-2 gap-2 border border-red-200/50 bg-primary-400 rounded-lg text-sm tracking-wide"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram instagram rounded-lg px-1 py-1" viewBox="0 0 16 16">
