...
const Tools = () => {
  useEffect(() => {
    const tools_list = ["android.png","java.png","icons8-c-48.png","python.png","bash.png","html.png","css.png","js.png","icons8-tailwindcss-48.png","nextjs.png","nodejs.png","icons8-figma-48.png"]
